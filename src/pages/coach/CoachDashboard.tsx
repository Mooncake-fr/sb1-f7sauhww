...
import { Users, TrendingUp, Calendar, MessageSquare, Search, Plus, X } from 'lucide-react';
...
function NewAthleteModal({ isOpen, onClose, onSubmit }: NewAthleteModalProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex justify-between items-center">
          ...
          <Button onClick={() => setShowNewAthleteModal(true)}>
